...
class MoviesFragment(val layoutId:Int) : Fragment() {
    // inflate the layout
            ...
            //    var layoutId=R.layout.item_home_viewpager
             ...
             //   layoutId=R.layout.item_b
              ...
              //  layoutId=R.layout.item_d
                category = MovieCategory(1,"Top 20 Movies",movies.shuffled(), layoutId)
                dataList.add(category)
                category = MovieCategory(1,"Recommended Movies for you",movies.shuffled(), layoutId)
                dataList.add(category)
                ...
                category = MovieCategory(1,"Most Rated Indian Movies",movies.shuffled(), layoutId)
                dataList.add(category)
                category = MovieCategory(1,"Popular Right Now",movies.shuffled(), layoutId)
                dataList.add(category)
                category = MovieCategory(1,"Best From South",movies.shuffled(), layoutId)
                dataList.add(category)
