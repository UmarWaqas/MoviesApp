...
class BhaktiFragment(val layoutId:Int=R.layout.item_a) : Fragment() {
    // inflate the layout
            ...
            //    var layoutId=R.layout.item_home_viewpager
             ...
             //   layoutId=R.layout.item_b
              ...
              //  layoutId=R.layout.item_d
                category = MovieCategory(1,"Katha Vachan",movies.shuffled(), layoutId)
                dataList.add(category)
                category = MovieCategory(1,"Devotional Shows",movies.shuffled(), layoutId)
                dataList.add(category)
